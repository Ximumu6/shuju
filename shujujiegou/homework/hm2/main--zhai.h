...
int main() {
	...
	char a1[] = "9.8-6.4";
	cout << "9.8-6.4=" << evaluate(a1) << endl;
	char a2[] = "9*7";
	cout << "9*7=" << evaluate(a2) << endl;
	char a3[] = "9/3";
	cout << "9/3=" << evaluate(a3) << endl;
	char a4[] = "6^9";
	cout << "6^9=" << evaluate(a4) << endl;
	char a5[] = "2!";
	cout << "2!=" << evaluate(a4) << endl;
	char a6[] = "(7.7+8.6)*(9.8-6.4)+9*7+9/3+6^9+2!";
	cout << "(7.7+8.6)*(9.8-6.4)+9*7+9/3+6^9+2!=" << evaluate(a6) << endl;//一些例子 
